...
function computeLinks(){
    ...
    link = link.data(links, function(d) { return d; })
                .join(
                    ...
                    .attr("fill", "none")
                    .attr("id", function(d) { return "link-ppl-"+d.source.attendee_id+"-reason-"+d.target.reason_id; })
...
function computeReasons(){
    reason = reason.data(reasons, function(d) { return d;})
                    .join(
                        ...
                        .attr("stroke-dasharray","2,2")
                        .attr("r", 50)
                        .attr("id", function(d){ return "reason-"+d.reason_id;})
...
function highlightPeople(attendeeid){
    ...
    //1. highlight the user as well as the people paired with -- done
...
function highlightPairs(attendeeid){
